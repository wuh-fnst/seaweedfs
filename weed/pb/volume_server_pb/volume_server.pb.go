...
var file_volume_server_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x74, 0x74, 0x6c, 0x32, 0xc8, 0x20, 0x0a, 0x0c, 0x56, 0x6f,
	...
	0x01, 0x12, 0x6e, 0x0a, 0x11, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x4e, 0x65, 0x65, 0x64, 0x6c,
	...
	0x00, 0x12, 0x71, 0x0a, 0x12, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x4e, 0x65, 0x65, 0x64, 0x6c,
...
type VolumeServerClient interface {
	...
	VolumeNeedleWrite(ctx context.Context, in *VolumeNeedleWriteRequest, opts ...grpc.CallOption) (*VolumeNeedleWriteResponse, error)
...
func (c *volumeServerClient) VolumeNeedleWrite(ctx context.Context, in *VolumeNeedleWriteRequest, opts ...grpc.CallOption) (*VolumeNeedleWriteResponse, error) {
	out := new(VolumeNeedleWriteResponse)
	err := c.cc.Invoke(ctx, "/volume_server_pb.VolumeServer/VolumeNeedleWrite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VolumeServerServer interface {
	...
	VolumeNeedleWrite(context.Context, *VolumeNeedleWriteRequest) (*VolumeNeedleWriteResponse, error)
...
func (*UnimplementedVolumeServerServer) VolumeNeedleWrite(context.Context, *VolumeNeedleWriteRequest) (*VolumeNeedleWriteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VolumeNeedleWrite not implemented")
}
...
func _VolumeServer_VolumeNeedleWrite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VolumeNeedleWriteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VolumeServerServer).VolumeNeedleWrite(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/volume_server_pb.VolumeServer/VolumeNeedleWrite",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VolumeServerServer).VolumeNeedleWrite(ctx, req.(*VolumeNeedleWriteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
